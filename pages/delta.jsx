    ...
    <div className='w-full'>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
        <div className='col-span-4'>
          ...
          <h2>Overview</h2>
          <p className='mt-6'>
            A landing page about Security Systems
          </p>
          <a
            href='https://github.com/alexandre-omartins/react-delta'
            target='_blank'
            rel='noreferrer'
          >
          ...
          <a
            href='https://react-delta-pearl.vercel.app/'
            target='_blank'
            rel='noreferrer'
          >
